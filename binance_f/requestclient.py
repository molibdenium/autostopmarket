...
class RequestClient(object):
	...
	def get_leverage_bracket(self, symbol: 'str') -> any: #createdbyme
		'''
	...
	def change_position_mode(self, dualSidePosition: 'str') -> any: #createdbyme
		...
		return call_sync(self.request_impl.post_change_position_mode(dualSidePosition))


	def post_order(self, symbol: 'str', side: 'OrderSide', ordertype: 'OrderType', positionSide:'PositionSide'= PositionSide.BOTH,
				timeInForce: 'TimeInForce' = TimeInForce.INVALID, quantity: 'float' = None,
				reduceOnly: 'boolean' = None, price: 'float' = None,
				newClientOrderId: 'str' = None, stopPrice: 'float' = None, activationPrice: 'float'= None, callbackRate:'float'=None,
		...
		Send in a new order.
		"""
		return call_sync(self.request_impl.post_order(symbol, side, ordertype, positionSide,
				timeInForce, quantity, reduceOnly, price, newClientOrderId, stopPrice,activationPrice,callbackRate,workingType))
